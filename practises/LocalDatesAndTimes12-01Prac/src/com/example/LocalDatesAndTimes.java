...
public class LocalDatesAndTimes {
  ...
  public static void main(String[] args) {
    ...
    LocalDate abBorn = LocalDate.of(1809, FEBRUARY, 12);
    LocalDate abDies = LocalDate.of(1855, APRIL, 15);
      System.out.println("Abe was " + abBorn.until(abDies, YEARS) + " when he died.");
      System.out.println("Abe lived for " + abBorn.until(abDies, DAYS) + " days.");
      System.out.println("");
